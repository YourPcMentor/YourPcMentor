...
const ViewCustomerServiceRequests = () => {
  ...
  const retrieveAllServiceRequests = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/service/request/fetch/customer-wise?customerId=` +
        customer.id
    );
  ...
  const downloadRequirement = async (request) => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/service/request/requirement/${request.requirement_filename}/download`,
        {
  ...
  const cancelServiceRequest = (serviceRequestId) => {
    fetch(
      `${process.env.REACT_APP_API_URL}/service/request/close?serviceRequestId=` +
        serviceRequestId,
      {
        method: "GET",
        headers: {
  ...
  const updateNegotiationMessage = (negotiationId, e) => {
    ...
    fetch(
      `${process.env.REACT_APP_API_URL}/service/request/negotiation/customer/update`,
      {
        method: "POST",
        headers: {
          Accept: "application/json",
