...
const MyWallet = () => {
  ...
  const retrieveMyWallet = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/user/fetch/user-id?userId=` + user.id
    );
  ...
  const addMoneyInWallet = (e) => {
    fetch(`${process.env.REACT_APP_API_URL}/user/update/wallet`, {
      method: "PUT",
      headers: {
        ...
        result.json().then((res) => {
          if (res.success) {
            ...
            options.handler = function(response) {
              ...
              fetch(`${process.env.REACT_APP_API_URL}/user/razorpPay/response`, {
                method: "PUT",
                headers: {
                  Accept: "application/json",
                 "Content-Type": "application/json",
